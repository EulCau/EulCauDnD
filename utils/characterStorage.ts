...
export const normalizeCharacter = (raw: Partial<CharacterData> = {}): CharacterData => {
  ...
  const next = {
    ...
    damageImmunities: Array.isArray(raw.damageImmunities) ? [...raw.damageImmunities] : defaults.damageImmunities,
    damageVulnerabilities: Array.isArray(raw.damageVulnerabilities) ? [...raw.damageVulnerabilities] : defaults.damageVulnerabilities,
    conditionImmunities: Array.isArray(raw.conditionImmunities) ? [...raw.conditionImmunities] : defaults.conditionImmunities,
